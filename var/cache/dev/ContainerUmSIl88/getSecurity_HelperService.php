...
class getSecurity_HelperService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.helper'] = new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'debug.App\\Security\\AppCustomAuthenticator' => ['privates', 'debug.App\\Security\\AppCustomAuthenticator', 'getAppCustomAuthenticator2Service', true],
            'debug.security.authenticator.remember_me.main' => ['privates', 'debug.security.authenticator.remember_me.main', 'getDebug_Security_Authenticator_RememberMe_MainService', true],
        ], [
            'debug.App\\Security\\AppCustomAuthenticator' => '?',
            'debug.security.authenticator.remember_me.main' => '?',
        ])]);
    }
}
