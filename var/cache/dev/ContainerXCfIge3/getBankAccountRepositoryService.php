 ...
 */
class getBankAccountRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BankAccountRepository' shared autowired service.
     *
     * @return \App\Repository\BankAccountRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BankAccountRepository.php';

        return $container->privates['App\\Repository\\BankAccountRepository'] = new \App\Repository\BankAccountRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
